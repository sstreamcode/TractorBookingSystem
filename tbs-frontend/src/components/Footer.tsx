        ...
        <footer className="bg-background text-foreground pt-12 pb-8 border-t border-border dark:bg-slate-900 dark:text-slate-100">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-lg font-bold mb-6 text-foreground dark:text-slate-100">Quick Links</h4>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="text-lg font-bold mb-6 text-foreground dark:text-slate-100">Contact Us</h4>
                        <ul className="space-y-4">
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="text-lg font-bold mb-6 text-foreground dark:text-slate-100">Newsletter</h4>
                        <p className="text-muted-foreground dark:text-slate-400 mb-4">Subscribe to get the latest updates and offers.</p>
